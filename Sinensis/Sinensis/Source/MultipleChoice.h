...
//==============================================================================
class MultipleChoice : public juce::Component
{
public:
    //==============================================================================
    enum RadioButtonIds
    ...
    juce::TextButton maleButton{ "Male" },
        femaleButton{ "Female" };
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment>outputVolumeAttachement;
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultipleChoice)
};
